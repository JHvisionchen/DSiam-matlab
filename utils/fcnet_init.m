function [state,opts] = fcnet_init(img,state,netname,nettype)
    ...
    % nettype: 0res,1res
    % vlr: learning rate for target variation transformation. when using 'jointtrain',this parameter is off-line learnt
    % wlr: learning rate for background suppression transformation. when using 'jointtrain',this parameter is off-line learnt
    % lambda: regularization parameter for all 2 transformation. when using 'jointtrain',this parameter is off-line learnt
    ...
    switch opts.prenet
        ...
        case 'vgg19'   
            ...
            netpath = fullfile('/media/cjh/cvpaper/git/models/dsiam_models','imagenet-vgg-verydeep-19.mat');  
        ...
        case 'siamfc'
            ...
            opts.v_lambda = 1e-5;%
            opts.v1_lambda = 1e-5;%
            netpath = fullfile('/media/cjh/cvpaper/git/models/dsiam_models','siamfcnet_gray.mat');
            % initial obj conv net from siamfc net
